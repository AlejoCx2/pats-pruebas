...
import AproveUserForm from "./AproveUserForm";
import AproveUserTable from "./AproveUserTable";
...
function AproveUser() {
  ...
  const getPendingRequests = () => {
    ...
    fetch(
      import.meta.env.VITE_API_URL + "PATS/users/request_user/list/to_approve",
      options
    )
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <>
      ...
      {requestSelected && (
        <MainCard title="Aprobar usuario" addClass="">
          <AproveUserForm
